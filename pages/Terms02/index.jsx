        ...
        <>
            ...
            <div className="text-lg max-w-prose mx-auto">
                ...
                <p className="mt-6 text-xl text-gray-500 leading-8 ">
                    주식회사 엔엔피케이(이하 '회사')는 개인정보보호법에 따라
                    이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한
                    이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은
                    처리방침을 두고 있습니다. 회사는 개인정보처리방침을 개정하는
                    경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할
                    것입니다.
                </p>
                ...
                <p className="mt-6 text-gray-500">
                    회사는 개인정보를 홈페이지 회원가입 및 관리, 민원사무 처리,
                    재화 또는 서비스 제공, 마케팅 및 광고 활용의 목적을 위해
                    처리합니다. 처리한 개인정보는 목적이외의 용도로는 사용되지
                    않으며 이용 목적이 변경될 시에는 사전 동의를 구할
                    예정입니다.
                </p>
                <p className="mt-6 text-xl text-gray-500 font-bold">
                    2. 홈페이지 회원가입 및 관리
                ...
                <p className="mt-6 text-gray-500">
                    ...
                    본인확인, 서비스 부정이용 방지, 만14세 미만 아동 개인정보
                    수집 시 법정대리인 동의 여부 확인, 각종 고지·통지, 고충처리,
                    분쟁 조정을 위한 기록 보존 등을 목적으로 개인정보를
                    처리합니다.
                </p>
                <p className="mt-6 text-xl text-gray-500 font-bold">
                    3. 민원사무 처리
                ...
                <p className="mt-6 text-gray-500">
                    서비스 제공, 청구서 발송, 콘텐츠 제공, 맞춤 서비스 제공,
                ...
                <ol className="list-decimal text-gray-500 mt-4 ml-5">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                가. 개인정보를 제공받는 자 : 실명확인을 위한
                                금융거래 관련사.
                            </li>
                            <li>
                                나. 제공받는 자의 개인정보 이용목적 : 해외송금
                                서비스 운영
                            </li>
                            <li>
                                다. 제공하는 개인정보 항목 : 이름, 주소,
                                생년월일, 직업, 고용주이름, 연락처, 국적,
                                주민등록번호, 자금원, 송금목적 등
                                해외송금서비스에 필요한 제반 정보
                            </li>
                            <li>
                                라. 제공받는 자의 보유․이용기간 : 해외송금
                                협약계약에 따른 거래기간동안
                            </li>
                        </ul>
                    </li>
                ...
                <p className="mt-6 text-gray-500">
                    개인정보 항목 : 자택주소, 비밀번호 질문과 답, 비밀번호,
                    생년월일, 자택전화번호, 성별, 로그인ID, 휴대전화번호, 이름,
                    이메일, 회사명, 직책, 회사전화번호, 직업, 부서, 기념일,
                    은행계좌정보, 결제기록, 접속 IP 정보, 쿠키, 서비스 이용
                    기록, 접속 로그, 법정대리인 휴대전화번호, 법정대리인 자택
                    주소, 법정대리인 자택 전화번호, 법정대리인 이름
                </p>
                <p className="mt-2 text-gray-500">
                    ...
                    신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년, 대금결제
                    및 재화 등의 공급에 관한 기록 : 5년, 계약 또는 청약철회 등에
                    관한 기록 : 5년, 표시/광고에 관한 기록 : 6개월
                </p>
                <p className="mt-6 text-xl text-gray-500 font-bold">
                    8. 개인정보처리 위탁
                </p>
                ...
                <ol className="list-decimal text-gray-500 mt-4 ml-5">
                    ...
                    <li>
                        ...
                        모사전송(FAX) 등을 통하여 하실 수 있으며 회사는 이에
                        대해 지체 없이 조치하겠습니다.
                    </li>
                    <li>
                ...
                <ol className="list-decimal text-gray-500 mt-4 ml-5">
                    <li>
                        홈페이지 회원가입 및 관리
                        <br />
                        필수항목 : 자택주소, 비밀번호 질문과 답, 비밀번호,
                        생년월일, 자택전화번호, 성별, 로그인ID, 휴대전화번호,
                        이름, 이메일, 회사명, 직책, 회사전화번호, 직업, 부서,
                        기념일, 은행계좌정보, 결제기록, 접속 IP 정보, 쿠키,
                        서비스 이용 기록, 접속 로그, 법정대리인 휴대전화번호,
                        법정대리인 자택 주소, 법정대리인 자택 전화번호,
                        법정대리인 이름
                    </li>
                    <li>
                        민원사무 처리
                ...
                <ol className="list-decimal text-gray-500 mt-4 ml-5">
                    <li>
                        ...
                        개인정보 보호책임자
                        <br />
                        성명 : 주식회사 엔앤피코리아 사업본부 영업팀장
                        <br />
                        연락처 : 전화 02-755-6321 Fax 02-755-6320
                    </li>
                    <li>
                        정보주체께서는 회사의 서비스(또는 사업)을 이용하시면서
                        발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
                        등에 관한 사항을 개인정보 보호책임자 및 담당부서로
                        문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체
                        없이 답변 및 처리해드릴 것입니다.
                    </li>
                </ol>
                <p className="mt-6 text-xl text-gray-500 font-bold">
