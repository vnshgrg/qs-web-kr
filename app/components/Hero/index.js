          ...
          <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-start">
            <div>
              <h1 className="mt-4 text-4xl leading-none font-semibold text-white sm:mt-5">
                <span className="text-blue-100 font-normal text-3xl md:block">
                  {t("title1")}
                </span>{" "}
                ...
                <div className="flex flex-wrap items-start">
                  <div className="flex w-full sm:w-auto">
                    <a
                      ...
                      target="_blank"
                      className="flex items-center bg-gradient-to-bl from-primary to-yellow-600 text-white text-lg font-bold tracking-wide px-6 py-3 pl-3 rounded-lg leading-tight hover:bg-blue-700 shadow-lg"
                    >
                      <svg
                      ...
                      <div>
                        <span className="block text-sm font-normal text-yellow-100 leading-tight">
                          {t("download-app")}
                        </span>
                        {t("for-ios")}
                      </div>
              ...
              <p>
                <Link
                  ...
                  className="mt-8 text-sm text-blue-50 tracking-wide sm:mt-10 border border-blue-300 inline-block px-5 py-2 rounded-full font-semibold hover:text-white hover:bg-blue-700"
                >
                  {t("track-transaction")}
                </Link>
              </p>
